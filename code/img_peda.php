    ...
    <div id="demo" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img src="imgp2.jpg" class="rounded mx-auto d-block " width= "95%" height="600px">
              </div>
          <div class="carousel-item ">
            <img src="imgp1.jpg" class="rounded mx-auto d-block " width= "95%" height="600px">
          </div>
          <div class="carousel-item">
            <img src="imgp3.jpg" class="rounded mx-auto d-block " width= "95%" height="600px">
          </div>
          <div class="carousel-item ">
            <img src="imgp4.jpg" class="rounded mx-auto d-block " width= "95%" height="600px" >
          </div>
          <div class="carousel-item">
            <img src="imgp5.jpg" class="rounded mx-auto d-block " width= "95%" height="600px">
          </div>
          <div class="carousel-item">
            <img src="imgp6.jpg" class="rounded mx-auto d-block " width= "95%" height="600px" >
          </div>
          <div class="carousel-item ">
            <img src="imgp7.jpg" class="rounded mx-auto d-block " width= "95%" height="600px">
          </div>
          <div class="carousel-item">
            <img src="imgp8.JPG" class="rounded mx-auto d-block " width= "95%" height="600px">
          </div>
          <div class="carousel-item" >
            <img src="imgp9.jpg" class="rounded mx-auto d-block " width= "95%" height="600px" >
          </div>
          <div class="carousel-item">
            <img src="imgp10.jpg" class="rounded mx-auto d-block " width= "95%" height="600px" >
          </div>
...
<br> <br> <br> <br> <br>
    ...
    <p style="font-size:30px;text-align:center; color:brown; ">More photos :</p>
      <div style="text-align: center ;">
      <a href="img_act.php" class="btn btn-secondary active " style="width: 600px;" >Activités parascolaires</a>
      </div>
      <br><div style="text-align: center ;">
      <a href="img_mat.php" class="btn btn-secondary active " style="width: 600px;" >Materiel</a>
      </div>
      <br> <br> <br> <br>
      <br> <br> <br> <br>
