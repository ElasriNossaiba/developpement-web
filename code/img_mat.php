    ...
    <div id="demo" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img src="imgm2.jpg" class="rounded mx-auto d-block " width= "95%" height="600px">
              </div>
          <div class="carousel-item ">
            <img src="imgm1.jpg" class="rounded mx-auto d-block " width= "95%" height="600px">
          </div>
          <div class="carousel-item">
            <img src="imgm3.jpg" class="rounded mx-auto d-block " width= "95%" height="600px">
          </div>
          <div class="carousel-item ">
            <img src="imgm4.jpg" class="rounded mx-auto d-block " width= "95%" height="600px" >
          </div>
          <div class="carousel-item">
            <img src="imgm5.jpg" class="rounded mx-auto d-block " width= "95%" height="600px">
          </div>
          <div class="carousel-item">
            <img src="imgm6.jpg" class="rounded mx-auto d-block " width= "95%" height="600px" >
          </div>
