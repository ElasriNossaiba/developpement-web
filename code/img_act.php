    ...
    <div id="demo" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img src="imga10.jpg" class="rounded mx-auto d-block " width= "95%" height="600px">
              </div>
          <div class="carousel-item ">
            <img src="imga1.jpg" class="rounded mx-auto d-block " width= "95%" height="600px">
          </div>
          <div class="carousel-item">
            <img src="imga3.jpg" class="rounded mx-auto d-block " width= "95%" height="600px">
          </div>
          <div class="carousel-item ">
            <img src="imga4.jpg" class="rounded mx-auto d-block " width= "95%" height="600px" >
          </div>
          <div class="carousel-item">
            <img src="imga5.jpg" class="rounded mx-auto d-block " width= "95%" height="600px">
          </div>
          <div class="carousel-item">
            <img src="imga6.jpg" class="rounded mx-auto d-block " width= "95%" height="600px" >
          </div>
          <div class="carousel-item ">
            <img src="imga7.jpg" class="rounded mx-auto d-block " width= "95%" height="600px">
          </div>
          <div class="carousel-item">
            <img src="imga8.JPG" class="rounded mx-auto d-block " width= "95%" height="600px">
          </div>
          <div class="carousel-item" >
            <img src="imga9.jpg" class="rounded mx-auto d-block " width= "95%" height="600px" >
          </div>
          <div class="carousel-item">
            <img src="imga2.jpg" class="rounded mx-auto d-block " width= "95%" height="600px" >
          </div>
...
<br> <br> <br> <br> <br>
    ...
    <p style="font-size:30px;text-align:center; color:brown; ">More photos :</p>
      ...
      <a href="img_peda.php" class="btn btn-secondary active " style="width: 600px;" >Sorties pédagogiques</a>
      </div>
