  ...
  <nav class="navbar navbar-expand-xl navbar-dark bg-dark" >
    ...
    <h1 style="font-size:30px;text-align:center; color:brown; ">Cours :</h1>
      <div style="text-align: center ;">
        <br>
      <a href="p5_arabe_c.docx" class="btn btn-secondary active " style="width: 600px;" >Arabe</a>
      </div>
      <br>
      <div style="text-align: center ;">
      <a href="p5_francais_C.docx" class="btn btn-secondary active " style="width: 600px;" >francais</a>
      </div><br>
      <div style="text-align: center ;">
        <a href="p5_maths_C.docx" class="btn btn-secondary active " style="width: 600px;" >Maths</a>
    </div><br>
    <div style="text-align: center ;">
        <a href="p5_EI_C.docx" class="btn btn-secondary active " style="width: 600px;" >Etude Islamique</a>
    </div>
    ...
    <h1 style="font-size:30px;text-align:center; color:brown; ">Exercices :</h1>
      <div style="text-align: center ;">
        <br>
      <a href="p5_arabe_E.docx" class="btn btn-secondary active " style="width: 600px;" >Arabe</a>
      </div>
      <br>
      <div style="text-align: center ;">
      <a href="p5_francais_E.docx" class="btn btn-secondary active " style="width: 600px;" >francais</a>
       
    </div><br> 
      <div style="text-align: center ;">
        <a href="P5_maths_E.docx" class="btn btn-secondary active " style="width: 600px;" >Maths</a>
    </div><br>
    <div style="text-align: center ;">
        <a href="p5_EI_E.docx" class="btn btn-secondary active " style="width: 600px;" >Etude Islamique</a>
    </div>
